...
3. To tests for all the problems of this week run ```npx jest ./tests/``` (this command may not work for all so use ```sudo apt install jest``` to install jest to run the aforementioned command)
